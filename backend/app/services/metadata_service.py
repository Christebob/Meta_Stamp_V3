...
class MetadataService:
    ...
    async def extract_image_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Cannot identify image file: {file_path} - {e}")
    ...
    async def extract_audio_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Error extracting audio metadata from {file_path}: {e}")
    ...
    async def extract_video_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"OpenCV error extracting video metadata: {e}")
            raise ValueError(f"Error extracting video metadata: {e}") from e
        except Exception as e:
            self.logger.error(f"Error extracting video metadata from {file_path}: {e}")
            raise
        finally:
    ...
    async def extract_text_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Error extracting text metadata from {file_path}: {e}")
    ...
    async def extract_metadata(
        ...
        try:
            ...
            self.logger.error(
                f"Error during type-specific metadata extraction: {e}"
            )
