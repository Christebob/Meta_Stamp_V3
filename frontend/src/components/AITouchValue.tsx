...
const AITouchValue: React.FC<AITouchValueProps> = ({
  ...
  const [modelEarnings, setModelEarnings] =
    useState<number>(initialModelEarnings);
  const [contributionScore, setContributionScore] = useState<number>(
    initialContributionScore
  );
  const [exposureScore, setExposureScore] =
    useState<number>(initialExposureScore);

  // State for calculated value
  const [calculatedValue, setCalculatedValue] = useState<number>(0);

  // State for explanation panel visibility
  const [isExplanationExpanded, setIsExplanationExpanded] =
   ...
   */
  useEffect(() => {
    const newValue = calculateAITouchValue(
      modelEarnings,
      contributionScore,
      exposureScore
    );
   ...
   */
  const handleEarningsSliderChange = (
   ...
   */
  const handleEarningsInputChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ): void => {
    ...
    if (
      !isNaN(numericValue) &&
      numericValue >= 0 &&
      numericValue <= MAX_MODEL_EARNINGS
    ) {
  ...
  const handleEarningsInputBlur = (): void => {
    const numericValue =
      parseFloat(earningsInputValue.replace(/[^0-9.]/g, '')) || 0;
  ...
  const calculateProjectionValue = (scenario: ProjectionScenario): number => {
    return calculateAITouchValue(
      modelEarnings,
      scenario.contributionScore,
      scenario.exposureScore
    );
  };
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            {projectionScenarios.map((scenario) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 mb-1">
                  Contribution: {scenario.contributionScore}% | Exposure:{' '}
                  {scenario.exposureScore}%
                </div>
      ...
      <div className="mt-8 border-t pt-6">
        ...
        {isExplanationExpanded && (
          ...
          >
            <p>
              <strong>AI Touch Value™</strong> estimates your compensation
              based on your asset's contribution to AI model training. It
              represents the monetary value you're entitled to when AI companies
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 pl-2">
                <li>
                  <strong>Model Earnings:</strong> Total revenue generated by
                  the AI model that used your content for training.
                </li>
                <li>
                  <strong>Training Contribution (0-100%):</strong> How much your
                  asset contributed to the model's training data. Higher
                  uniqueness and quality increase this score.
                </li>
                <li>
                  <strong>Usage Exposure (0-100%):</strong> How frequently your
                  asset was encountered and used during training. More exposure
                  means higher compensation.
                </li>
                <li>
                  <strong>Equity Factor (25%):</strong> Fixed creator
                  compensation rate. This ensures creators receive a fair share
                  of AI-generated revenue.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-3">
              ...
              <p className="text-blue-700">
                ...
                <strong> 50% contribution</strong> and{' '}
                <strong>50% exposure</strong>, your AI Touch Value™ would be:
              </p>
